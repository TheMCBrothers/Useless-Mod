...
public class RecipeCategoryUid {
	...
	public static final ResourceLocation ELECTRIC_CRUSHER = new ResourceLocation(UselessMod.MOD_ID, "electric_crusher_category");
	...
	public static final ResourceLocation GENERATOR = new ResourceLocation(UselessMod.MOD_ID, "generator_category");
