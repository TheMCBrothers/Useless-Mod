...
public class EndOreFeature extends OreFeature {
    ...
    private Predicate<BlockState> target = new BlockMatcher(Blocks.END_STONE);

    public EndOreFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> configFactoryIn) {
                                ...
                                for(int j2 = l; j2 <= k1; ++j2) {
                                    ...
                                    if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                                        ...
                                        if (!bitset.get(k2)) {
                                            ...
                                            if (this.target.test(worldIn.getBlockState(blockpos$mutable))) {
