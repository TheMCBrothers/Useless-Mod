...
public class UselessTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState LOG = ModBlocks.USELESS_LOG.getDefaultState();
   private static final BlockState LEAF = ModBlocks.USELESS_LEAVES.getDefaultState();
   private final boolean useExtraRandomHeight;

   public UselessTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, boolean extraRandomHeightIn) {
      super(configIn, doBlockNotifyIn);
      this.useExtraRandomHeight = extraRandomHeightIn;
      this.setSapling((net.minecraftforge.common.IPlantable)ModBlocks.USELESS_SAPLING);
   }
