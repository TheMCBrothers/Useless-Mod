...
public class EnergyAxeItem extends AxeItem implements IEnergyDurabilityItem {

    public EnergyAxeItem(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder) {
