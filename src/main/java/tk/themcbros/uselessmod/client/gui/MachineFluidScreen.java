...
public abstract class MachineFluidScreen<T extends Container> extends ContainerScreen<T> {

	private static final int DEFAULT_TANK_WIDTH = 16;
	private static final int DEFAULT_TANK_HEIGHT = 45;
	...
	public MachineFluidScreen(T screenContainer, PlayerInventory inv, ITextComponent titleIn, int capacityMb) {
