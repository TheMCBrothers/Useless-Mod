...
public class ChargerScreen extends ContainerScreen<ChargerContainer> {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(UselessMod.MOD_ID, "textures/gui/container/charger.png");

	private final Rectangle energyBar = new Rectangle(152, 6, 16, 45);

	public ChargerScreen(ChargerContainer container, PlayerInventory playerInv, ITextComponent title) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		this.blit(i + this.energyBar.x, j + this.energyBar.y + this.energyBar.height - k, 177, 1, this.energyBar.width, k);
	}
