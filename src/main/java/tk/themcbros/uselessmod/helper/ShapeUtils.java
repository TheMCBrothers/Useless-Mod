...
public class ShapeUtils {
	...
	public static VoxelShape rotate(VoxelShape source, Direction direction) {
		double[] adjustedValues = adjustValues(direction, source.getStart(Direction.Axis.X),
				source.getStart(Direction.Axis.Z), source.getEnd(Direction.Axis.X), source.getEnd(Direction.Axis.Z));
		return VoxelShapes.create(adjustedValues[0], source.getStart(Direction.Axis.Y), adjustedValues[1],
				adjustedValues[2], source.getEnd(Direction.Axis.Y), adjustedValues[3]);
	}
