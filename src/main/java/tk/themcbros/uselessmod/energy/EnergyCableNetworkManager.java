...
public class EnergyCableNetworkManager {
	...
	@Nullable
	public static EnergyCableNetwork get(IBlockReader world, BlockPos pos) {
		return getLazy(world, pos).orElse(null);
	}

	public static LazyOptional<EnergyCableNetwork> getLazy(IBlockReader world, BlockPos pos) {
