...
public class NoRemainingShapelessRecipe implements ICraftingRecipe {
    ...
    public NoRemainingShapelessRecipe(ResourceLocation id, String group, ItemStack recipeOutput, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.group = group;
    ...
    public IRecipeSerializer<?> getSerializer() {
        return RecipeSerializers.NO_REMAINING_SHAPELESS;
    }
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<NoRemainingShapelessRecipe> {
        ...
        @Override
        public NoRemainingShapelessRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            if (nonnulllist.isEmpty()) {
                ...
                return new NoRemainingShapelessRecipe(recipeId, s, itemstack, nonnulllist);
            }
        }
        ...
        @Override
        public NoRemainingShapelessRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void write(PacketBuffer buffer, NoRemainingShapelessRecipe recipe) {
