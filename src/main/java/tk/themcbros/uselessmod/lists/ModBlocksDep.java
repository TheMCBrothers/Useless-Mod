...
//	@ObjectHolder("useless_fern")
//	public static final Block USELESS_FERN = null;
//	@ObjectHolder("large_useless_fern")
//	public static final Block LARGE_USELESS_FERN = null;
//	@ObjectHolder("tall_useless_grass")
//	public static final Block TALL_USELESS_GRASS = null;
//	@ObjectHolder("potted_useless_fern")
//	public static final Block POTTED_USELESS_FERN = null;
//	@ObjectHolder("useless_log")
//	public static final Block USELESS_LOG = null;
//	@ObjectHolder("stripped_useless_log")
//	public static final Block STRIPPED_USELESS_LOG = null;
//	@ObjectHolder("useless_wood")
//	public static final Block USELESS_WOOD = null;
//	@ObjectHolder("stripped_useless_wood")
//	public static final Block STRIPPED_USELESS_WOOD = null;
//	@ObjectHolder("useless_planks")
//	public static final Block USELESS_PLANKS = null;
//	@ObjectHolder("useless_slab")
//	public static final Block USELESS_SLAB = null;
//	@ObjectHolder("useless_stairs")
//	public static final Block USELESS_STAIRS = null;
//	@ObjectHolder("useless_sapling")
//	public static final Block USELESS_SAPLING = null;
//	@ObjectHolder("potted_useless_sapling")
//	public static final Block POTTED_USELESS_SAPLING = null;
//	@ObjectHolder("useless_leaves")
//	public static final Block USELESS_LEAVES = null;
//	@ObjectHolder("useless_fence")
//	public static final Block USELESS_FENCE = null;
//	@ObjectHolder("useless_sign")
//	public static final Block USELESS_SIGN = null;
//	@ObjectHolder("useless_wall_sign")
//	public static final Block USELESS_WALL_SIGN = null;
//	@ObjectHolder("useless_pressure_plate")
//	public static final Block USELESS_PRESSURE_PLATE = null;
//	@ObjectHolder("useless_trapdoor")
//	public static final Block USELESS_TRAPDOOR = null;
//	@ObjectHolder("useless_fence_gate")
//	public static final Block USELESS_FENCE_GATE = null;
//	@ObjectHolder("useless_button")
//	public static final Block USELESS_BUTTON = null;
//	@ObjectHolder("wooden_useless_door")
//	public static final Block WOODEN_USELESS_DOOR = null;
//	
...
//			registry.register(new UselessTallGrassBlock(Block.Properties.create(Material.TALL_PLANTS).sound(SoundType.PLANT).doesNotBlockMovement()).setRegistryName(BlockNames.USELESS_FERN));
//			registry.register(new UselessDoublePlantBlock(Block.Properties.create(Material.TALL_PLANTS).sound(SoundType.PLANT).doesNotBlockMovement()).setRegistryName(BlockNames.LARGE_USELESS_FERN));
//			registry.register(new UselessDoublePlantBlock(Block.Properties.create(Material.TALL_PLANTS).sound(SoundType.PLANT).doesNotBlockMovement()).setRegistryName(BlockNames.TALL_USELESS_GRASS));
//			registry.register(new FlowerPotBlock(USELESS_FERN, Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0F)).setRegistryName(BlockNames.POTTED_USELESS_FERN));
//			registry.register(new LogBlock(MaterialColor.WOOD, Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(BlockNames.USELESS_LOG));
//			registry.register(new LogBlock(MaterialColor.WOOD, Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(BlockNames.STRIPPED_USELESS_LOG));
//			registry.register(new RotatedPillarBlock(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(BlockNames.USELESS_WOOD));
//			registry.register(new RotatedPillarBlock(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName(BlockNames.STRIPPED_USELESS_WOOD));
//			registry.register(new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName(BlockNames.USELESS_PLANKS));
//			registry.register(new SlabBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName(BlockNames.USELESS_SLAB));
//			registry.register(new UselessStairsBlock(Blocks.OAK_PLANKS.getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName(BlockNames.USELESS_STAIRS));
//			registry.register(new UselessSaplingBlock(new UselessTree(), Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT)).setRegistryName(BlockNames.USELESS_SAPLING));
//			registry.register(new FlowerPotBlock(USELESS_SAPLING, Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0F)).setRegistryName(BlockNames.POTTED_USELESS_SAPLING));
//			registry.register(new LeavesBlock(Block.Properties.create(Material.LEAVES).tickRandomly().hardnessAndResistance(0.2F).sound(SoundType.PLANT)).setRegistryName(BlockNames.USELESS_LEAVES));
//			registry.register(new FenceBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName(BlockNames.USELESS_FENCE));
//			registry.register(new StandingSignBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0f)).setRegistryName(BlockNames.USELESS_SIGN));
//			registry.register(new WallSignBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0f)).setRegistryName(BlockNames.USELESS_WALL_SIGN));
////			registry.register(new UselessPressurePlateBlock(Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD).doesNotBlockMovement().sound(SoundType.WOOD).hardnessAndResistance(0.5F)).setRegistryName(BlockNames.USELESS_PRESSURE_PLATE));
//			registry.register(new UselessTrapdoorBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3.0F)).setRegistryName(BlockNames.USELESS_TRAPDOOR));
//			registry.register(new FenceGateBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName(BlockNames.USELESS_FENCE_GATE));
//			registry.register(new UselessWoodButtonBlock(Block.Properties.create(Material.WOOD).doesNotBlockMovement().sound(SoundType.WOOD).hardnessAndResistance(0.5F)).setRegistryName(BlockNames.USELESS_BUTTON));
//			registry.register(new ModDoorBlock(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3.0F)).setRegistryName(BlockNames.WOODEN_USELESS_DOOR));
//
...
//			registry.register(new UselessFlowerBlock(Effects.SPEED, 6, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)).setRegistryName(BlockNames.RED_ROSE));
//			registry.register(new UselessFlowerBlock(Effects.SPEED, 6, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)).setRegistryName(BlockNames.BLUE_ROSE));
...
//			registry.register(new ColorableBlock(Block.Properties.create(Material.WOOL).hardnessAndResistance(.5f)).setRegistryName(BlockNames.CANVAS));
...
//			registry.register(new TallBlockItem(USELESS_FERN, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_FERN));
//			registry.register(new TallBlockItem(TALL_USELESS_GRASS, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.TALL_USELESS_GRASS));
//			registry.register(new TallBlockItem(LARGE_USELESS_FERN, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.LARGE_USELESS_FERN));
//			registry.register(new BlockItem(USELESS_LOG, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_LOG));
//			registry.register(new BlockItem(STRIPPED_USELESS_LOG, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.STRIPPED_USELESS_LOG));
//			registry.register(new BlockItem(USELESS_WOOD, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_WOOD));
//			registry.register(new BlockItem(STRIPPED_USELESS_WOOD, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.STRIPPED_USELESS_WOOD));
//			registry.register(new BlockItem(USELESS_PLANKS, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_PLANKS));
//			registry.register(new BlockItem(USELESS_LEAVES, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_LEAVES));
//			registry.register(new TallBlockItem(USELESS_SAPLING, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(BlockNames.USELESS_SAPLING));
//			
...
//		}
//		
//		public static Block registerBlock(String name, Block block, BlockItem blockItem) {
...
//			return registerBlock(name, block, blockItem);
//		}
//	}
