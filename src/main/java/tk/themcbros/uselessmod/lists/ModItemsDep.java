...
//			registry.register(new AxeItem(ToolMaterialList.useless, 0, 1f, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(ItemNames.USELESS_AXE));
//			registry.register(new PickaxeItem(ToolMaterialList.useless, 0, 1f, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(ItemNames.USELESS_PICKAXE));
...
//			registry.register(new AxeItem(ToolMaterialList.super_useless, 0, 1f, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(ItemNames.SUPER_USELESS_AXE));
//			registry.register(new PickaxeItem(ToolMaterialList.super_useless, 0, 1f, new Item.Properties().group(ModItemGroups.USELESS_ITEM_GROUP)).setRegistryName(ItemNames.SUPER_USELESS_PICKAXE));
