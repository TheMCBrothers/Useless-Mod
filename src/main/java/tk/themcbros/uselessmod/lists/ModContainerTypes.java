...
public class ModContainerTypes {
	...
	public static final ContainerType<CoffeeMachineContainer> COFFEE_MACHINE = null;
	@ObjectHolder("closet")
	...
	public static class Registration {
		...
		public static void onContainerTypeRegister(final RegistryEvent.Register<ContainerType<?>> event) {
			...
			registry.register(new ContainerType<CoffeeMachineContainer>(CoffeeMachineContainer::new).setRegistryName(BlockNames.COFFEE_MACHINE));
