...
public final class UselessVegetationPlacements {
    public static final ResourceKey<PlacedFeature> FLOWER_USELESS = createKey("flower_default");
    public static final ResourceKey<PlacedFeature> TREES_USELESS_OAK = createKey("trees_useless_oak");
