...
import net.themcbrothers.uselessmod.world.item.*;
...
public final class UselessBlocks {
    ...
    public static final DeferredBlock<Block> USELESS_OAK_LEAVES = BLOCKS.registerBlock("useless_oak_leaves", properties -> new UntintedParticleLeavesBlock(0.2F, ColorParticleOption.create(ParticleTypes.TINTED_LEAVES, -9399763), properties), () -> ofFullCopy(Blocks.OAK_LEAVES));
    ...
    public static final DeferredBlock<Block> USELESS_BED = BLOCKS.registerBlock("useless_bed", props -> new UselessBedBlock(DyeColor.LIME, props), () -> ofFullCopy(Blocks.WHITE_CARPET), BedItem::new, props -> props.stacksTo(1));
    public static final DeferredBlock<Block> PAINTED_WOOL = BLOCKS.registerBlock("painted_wool", PaintedWoolBlock::new, () -> ofFullCopy(Blocks.WHITE_WOOL), ColorBlockItem::new);
    public static final DeferredBlock<Block> PAINT_BUCKET = BLOCKS.registerBlock("paint_bucket", PaintBucketBlock::new, props -> props.strength(2.5F).sound(SoundType.LANTERN));
    ...
    // Functional Blocks
    public static final DeferredBlock<Block> WALL_CLOSET = BLOCKS.registerBlock("wall_closet", WallClosetBlock::new, props -> props.strength(.5F),
            (block, props) -> new WallClosetBlockItem(block, props.component(UselessDataComponents.WALL_CLOSET_MATERIAL.get(), Holder.direct(Blocks.AIR))));
    public static final DeferredBlock<Block> MACHINE_SUPPLIER = BLOCKS.registerBlock("machine_supplier", MachineSupplierBlock::new, props -> props.strength(0.5F).dynamicShape().noOcclusion(), MachineSupplierBlockItem::new);
    public static final DeferredBlock<Block> COFFEE_MACHINE = BLOCKS.registerBlock("coffee_machine", CoffeeMachineBlock::new, props -> props.mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(3.0F).sound(SoundType.METAL),
    ...
    public static final DeferredBlock<Block> CUP = BLOCKS.registerBlock("cup", CupBlock::new, props -> props.strength(0.5F), (block, props) -> new CupBlockItem(block, props, false));
    public static final DeferredBlock<Block> CUP_COFFEE = BLOCKS.registerBlock("cup_coffee", CupCoffeeBlock::new, props -> props.strength(0.5F), (block, props) -> new CupBlockItem(block, props.usingConvertsTo(CUP.asItem()), true));

    // Lights
    public static final DeferredBlock<Block> LIGHT_SWITCH = BLOCKS.registerBlock("light_switch", LightSwitchBlock::new, props -> props.noCollision().strength(.25F), LightSwitchBlockItem::new);
    public static final DeferredBlock<Block> LIGHT_SWITCH_BLOCK = BLOCKS.registerBlock("light_switch_block", LightSwitchBlockBlock::new, props -> props.strength(.5F), LightSwitchBlockItem::new);
