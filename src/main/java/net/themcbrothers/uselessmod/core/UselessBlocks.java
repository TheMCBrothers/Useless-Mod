...
public final class UselessBlocks {
    ...
    public static final DeferredBlock<Block> USELESS_OAK_WALL_SIGN = BLOCKS.registerNoItem("useless_oak_wall_sign", () -> new UselessWallSignBlock(UselessWoodTypes.USELESS_OAK, ofFullCopy(Blocks.OAK_WALL_SIGN).lootFrom(UselessBlocks.USELESS_OAK_SIGN)));
    public static final DeferredBlock<Block> USELESS_OAK_SIGN = BLOCKS.register("useless_oak_sign", () -> new UselessStandingSignBlock(UselessWoodTypes.USELESS_OAK, ofFullCopy(Blocks.OAK_SIGN)), block -> new SignItem(STACKS_TO_16_PROPS, block, UselessBlocks.USELESS_OAK_WALL_SIGN.get()));
    public static final DeferredBlock<Block> USELESS_OAK_WALL_HANGING_SIGN = BLOCKS.registerNoItem("useless_oak_wall_hanging_sign", () -> new UselessWallHangingSignBlock(UselessWoodTypes.USELESS_OAK, ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN).lootFrom(UselessBlocks.USELESS_OAK_SIGN)));
    public static final DeferredBlock<Block> USELESS_OAK_HANGING_SIGN = BLOCKS.register("useless_oak_hanging_sign", () -> new UselessCeilingHangingSignBlock(UselessWoodTypes.USELESS_OAK, ofFullCopy(Blocks.OAK_HANGING_SIGN)), block -> new HangingSignItem(block, UselessBlocks.USELESS_OAK_WALL_HANGING_SIGN.get(), STACKS_TO_16_PROPS));
    ...
    public static final DeferredBlock<Block> USELESS_WHEAT = BLOCKS.registerNoItem("useless_wheat", () -> new UselessCropBlock(false, UselessItems.USELESS_WHEAT_SEEDS, ofFullCopy(Blocks.WHEAT)));
    public static final DeferredBlock<Block> WILD_USELESS_WHEAT = BLOCKS.registerNoItem("wild_useless_wheat", () -> new UselessCropBlock(true, UselessItems.USELESS_WHEAT_SEEDS, ofFullCopy(Blocks.WHEAT)));
    public static final DeferredBlock<Block> COFFEE_BEANS = BLOCKS.registerNoItem("coffee_beans", () -> new UselessCropBlock(false, UselessItems.COFFEE_SEEDS, ofFullCopy(Blocks.WHEAT)));
    public static final DeferredBlock<Block> WILD_COFFEE_BEANS = BLOCKS.registerNoItem("wild_coffee_beans", () -> new UselessCropBlock(true, UselessItems.COFFEE_SEEDS, ofFullCopy(Blocks.WHEAT)));
