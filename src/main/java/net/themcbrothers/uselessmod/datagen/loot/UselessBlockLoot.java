...
public class UselessBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        this.add(USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_USELESS.get()));
        this.add(SUPER_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_SUPER_USELESS.get()));
        this.add(DEEPSLATE_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_USELESS.get()));
        this.add(DEEPSLATE_SUPER_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_SUPER_USELESS.get()));
        this.add(NETHER_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_USELESS.get()));
        this.add(NETHER_SUPER_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_SUPER_USELESS.get()));
        this.add(END_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_USELESS.get()));
        this.add(END_SUPER_USELESS_ORE.get(), (block) -> createOreDrop(block, UselessItems.RAW_SUPER_USELESS.get()));
        ...
        this.add(COFFEE_BEANS.get(), createCropDrops(COFFEE_BEANS.get(), UselessItems.COFFEE_BEANS.get(), UselessItems.COFFEE_SEEDS.get(), condition3));
