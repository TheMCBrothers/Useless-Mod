...
public class UselessDataMapsProvider extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        ...
        this.builder(NeoForgeDataMaps.STRIPPABLES)
                .add(UselessBlocks.USELESS_OAK_LOG.getKey(), new Strippable(UselessBlocks.STRIPPED_USELESS_OAK_LOG.get()), false)
                .add(UselessBlocks.USELESS_OAK_WOOD.getKey(), new Strippable(UselessBlocks.STRIPPED_USELESS_OAK_WOOD.get()), false)
        ;
    }
}
