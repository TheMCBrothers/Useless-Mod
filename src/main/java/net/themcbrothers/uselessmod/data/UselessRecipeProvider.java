...
public class UselessRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.USELESS_TRAPDOOR).define('#', UselessTags.Items.INGOTS_USELESS).pattern("##").pattern("##").unlockedBy(getHasName(ModItems.USELESS_INGOT), has(UselessTags.Items.INGOTS_USELESS)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.SUPER_USELESS_TRAPDOOR).define('#', UselessTags.Items.INGOTS_SUPER_USELESS).pattern("##").pattern("##").unlockedBy(getHasName(ModItems.SUPER_USELESS_INGOT), has(UselessTags.Items.INGOTS_SUPER_USELESS)).save(consumer);
