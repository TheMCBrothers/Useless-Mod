...
public class UselessEntityLoot extends EntityLoot {
    ...
    protected void addTables() {
        ...
        this.add(UselessLootTables.SHEEP_USELESS, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(ModBlocks.USELESS_BLOCK))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootTableReference.lootTableReference(ModEntityTypes.USELESS_SHEEP.get().getDefaultLootTable()))));
