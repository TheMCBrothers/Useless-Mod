...
public class UselessEntityLoot extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(ModEntityTypes.USELESS_SHEEP.get(), UselessLootTables.SHEEP_USELESS, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(ModBlocks.USELESS_WOOL))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(NestedLootTable.lootTableReference(ModEntityTypes.USELESS_SHEEP.get().getDefaultLootTable()))));
