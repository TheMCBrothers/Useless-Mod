...
public final class ModBlocks {
    ...
    public static final ItemObject<Block> USELESS_OAK_SIGN = BLOCKS.register("useless_oak_sign", () -> new UselessStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), UselessWoodTypes.USELESS_OAK), block -> new SignItem(STACKS_TO_16_PROPS, block, ModBlocks.USELESS_OAK_WALL_SIGN.get()));
    public static final RegistryObject<Block> USELESS_OAK_WALL_HANGING_SIGN = BLOCKS.registerNoItem("useless_oak_wall_hanging_sign", () -> new UselessWallHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_HANGING_SIGN).lootFrom(ModBlocks.USELESS_OAK_SIGN), UselessWoodTypes.USELESS_OAK));
    public static final ItemObject<Block> USELESS_OAK_HANGING_SIGN = BLOCKS.register("useless_oak_hanging_sign", () -> new UselessCeilingHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_HANGING_SIGN), UselessWoodTypes.USELESS_OAK), block -> new HangingSignItem(block, ModBlocks.USELESS_OAK_WALL_HANGING_SIGN.get(), STACKS_TO_16_PROPS));
    ...
    public static final ItemObject<Block> PAINT_BUCKET = BLOCKS.register("paint_bucket", () -> new PaintBucketBlock(of().strength(2.5F).sound(SoundType.LANTERN)), GENERAL_BLOCK_ITEM);
