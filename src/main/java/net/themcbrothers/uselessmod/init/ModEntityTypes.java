...
public final class ModEntityTypes {
    ...
    // CREATURES
    public static final DeferredHolder<EntityType<?>, EntityType<UselessSheep>> USELESS_SHEEP = ENTITIES.registerWithEgg("useless_sheep", () ->
            EntityType.Builder.of(UselessSheep::new, MobCategory.CREATURE).sized(0.9F, 1.3F).clientTrackingRange(10), 0x5EAF5B, 0xABD5A9);
    public static final DeferredHolder<EntityType<?>, EntityType<UselessPig>> USELESS_PIG = ENTITIES.registerWithEgg("useless_pig", () ->
            EntityType.Builder.of(UselessPig::new, MobCategory.CREATURE).sized(0.9F, 0.9F).clientTrackingRange(10), 0x5DAF5A, 0x41823F);
    public static final DeferredHolder<EntityType<?>, EntityType<UselessChicken>> USELESS_CHICKEN = ENTITIES.registerWithEgg("useless_chicken", () ->
            EntityType.Builder.of(UselessChicken::new, MobCategory.CREATURE).sized(0.4F, 0.7F).clientTrackingRange(10), 0xBFDFBE, 0x82C180);
    public static final DeferredHolder<EntityType<?>, EntityType<UselessCow>> USELESS_COW = ENTITIES.registerWithEgg("useless_cow", () ->
            EntityType.Builder.of(UselessCow::new, MobCategory.CREATURE).sized(0.9F, 1.4F).clientTrackingRange(10), 0x183017, 0x478D44);

    // MONSTERS
    public static final DeferredHolder<EntityType<?>, EntityType<UselessSkeleton>> USELESS_SKELETON = ENTITIES.registerWithEgg("useless_skeleton", () ->
