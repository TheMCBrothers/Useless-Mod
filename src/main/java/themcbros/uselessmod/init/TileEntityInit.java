...
public class TileEntityInit {
    ...
    public static final RegistryObject<TileEntityType<UselessBedTileEntity>> USELESS_BED =
    ...
    public static final RegistryObject<TileEntityType<UselessGeneratorTileEntity>> USELESS_GENERATOR =
            REGISTER.register("useless_generator", UselessGeneratorTileEntity::new, BlockInit.USELESS_GENERATOR);
    public static final RegistryObject<TileEntityType<CoffeeMachineTileEntity>> COFFEE_MACHINE =
            REGISTER.register("coffee_machine", CoffeeMachineTileEntity::new, BlockInit.COFFEE_MACHINE);
    public static final RegistryObject<TileEntityType<MachineSupplierTileEntity>> MACHINE_SUPPLIER =
            REGISTER.register("machine_supplier", MachineSupplierTileEntity::new, BlockInit.COFFEE_MACHINE_SUPPLIER);
    public static final RegistryObject<TileEntityType<CoffeeCupTileEntity>> COFFEE_CUP =
            REGISTER.register("coffee_cup", CoffeeCupTileEntity::new,
                    blockBuilder -> blockBuilder.add(BlockInit.CUP.get(), BlockInit.COFFEE_CUP.get()));
    ...
    public static final RegistryObject<TileEntityType<CanvasTileEntity>> CANVAS =
            REGISTER.register("canvas", CanvasTileEntity::new, BlockInit.CANVAS);

    public static final RegistryObject<TileEntityType<UselessSkullTileEntity>> USELESS_SKULL =
            REGISTER.register("useless_skull", UselessSkullTileEntity::new, blockBuilder ->
