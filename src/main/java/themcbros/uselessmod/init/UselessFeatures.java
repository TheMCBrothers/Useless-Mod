...
public class UselessFeatures {
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> USELESS_TREE_BEES = register("useless_bees_005",
            Feature.TREE.withConfiguration(USELESS_TREE.getConfig()
                    .copy(ImmutableList.of(Features.Placements.BEES_005_PLACEMENT))));
    ...
    private static final ImmutableList<Supplier<ConfiguredFeature<?, ?>>> ROSES = ImmutableList.of(
            () -> Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(States.USELESS_ROSE), new SimpleBlockPlacer())).tries(64).preventProjection().build()),
            () -> Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(States.RED_ROSE), new SimpleBlockPlacer())).tries(64).preventProjection().build()),
            () -> Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(States.BLUE_ROSE), new SimpleBlockPlacer())).tries(64).preventProjection().build()));
    public static final ConfiguredFeature<?, ?> USELESS_ROSES = register("useless_roses", Feature.SIMPLE_RANDOM_SELECTOR.withConfiguration(new SingleRandomFeature(ROSES)).countSpread(FeatureSpread.create(-3, 4)).withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).count(5));

    // Ores
    public static final ConfiguredFeature<?, ?> USELESS_ORE = register("ore_useless", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.USELESS_ORE, 9)).range(64).square().count(20));
    public static final ConfiguredFeature<?, ?> USELESS_ORE_NETHER = register("ore_useless_nether", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, States.USELESS_ORE_NETHER, 9)).withPlacement(Features.Placements.NETHER_SPRING_ORE_PLACEMENT).square().count(10));
    public static final ConfiguredFeature<?, ?> USELESS_ORE_END = register("ore_useless_end", END_ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.USELESS_ORE_END, 9)).withPlacement(Features.Placements.SPRING_PLACEMENT).square().count(20));
    public static final ConfiguredFeature<?, ?> SUPER_USELESS_ORE = register("ore_super_useless", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.SUPER_USELESS_ORE, 9)).range(32).square().count(2));
    public static final ConfiguredFeature<?, ?> SUPER_USELESS_ORE_NETHER = register("ore_super_useless_nether", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, States.SUPER_USELESS_ORE_NETHER, 9)).withPlacement(Features.Placements.NETHER_SPRING_ORE_PLACEMENT).square().count(2));
    public static final ConfiguredFeature<?, ?> SUPER_USELESS_ORE_END = register("ore_super_useless_end", END_ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, States.SUPER_USELESS_ORE_END, 9)).withPlacement(Features.Placements.SPRING_PLACEMENT).square().count(2));
