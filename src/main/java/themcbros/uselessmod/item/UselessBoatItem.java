...
public class UselessBoatItem extends BoatItem {
    ...
    private final UselessBoatEntity.Type type;

    public UselessBoatItem(Properties properties, UselessBoatEntity.Type type) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
                UselessBoatEntity boatentity = new UselessBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
