...
public class UselessAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> advancementConsumer) {
        ...
        Advancement useless_biome = Advancement.Builder.builder().withParent(root).withDisplay(BlockInit.USELESS_SAPLING.get(), title("useless_biome"), description("useless_biome"), null, FrameType.TASK, true, true, false).withCriterion("useless_biome", uselessBiome()).register(advancementConsumer, id("useless_biome"));
