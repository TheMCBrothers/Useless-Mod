...
public class UselessRecipeProvider extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_WOOD.get(), 3).patternLine("##").patternLine("##").key('#', BlockInit.USELESS_OAK_LOG.get()).setGroup("bark").addCriterion("has_log", hasItem(BlockInit.USELESS_OAK_LOG.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.STRIPPED_USELESS_OAK_WOOD.get(), 3).patternLine("##").patternLine("##").key('#', BlockInit.STRIPPED_USELESS_OAK_LOG.get()).setGroup("bark").addCriterion("has_log", hasItem(BlockInit.STRIPPED_USELESS_OAK_LOG.get())).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(BlockInit.USELESS_OAK_PLANKS.get(), 4).addIngredient(useless_logs).addCriterion("has_useless_log", hasItem(useless_logs)).setGroup("planks").build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_PLANKS.get()).key('#', BlockInit.USELESS_OAK_SLAB.get()).patternLine("#").patternLine("#").setGroup("planks").addCriterion("has_slab", hasItem(BlockInit.USELESS_OAK_SLAB.get())).build(consumer, rl("useless_planks_from_slabs"));
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_STAIRS.get(), 4).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("#  ").patternLine("## ").patternLine("###").setGroup("wooden_stairs").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_SLAB.get(), 6).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("###").setGroup("wooden_slab").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_FENCE.get(), 3).key('#', Tags.Items.RODS_WOODEN).key('W', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("W#W").patternLine("W#W").setGroup("wooden_fence").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_FENCE_GATE.get()).key('#', Tags.Items.RODS_WOODEN).key('W', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("#W#").patternLine("#W#").setGroup("wooden_fence_gate").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_DOOR.get(), 3).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("##").patternLine("##").patternLine("##").setGroup("wooden_door").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_TRAPDOOR.get(), 2).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("###").patternLine("###").setGroup("wooden_trapdoor").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemInit.USELESS_OAK_BOAT.get()).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("# #").patternLine("###").setGroup("boat").addCriterion("in_water", enteredBlock(Blocks.WATER)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_CHEST.get()).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("###").patternLine("# #").patternLine("###").setGroup("chest").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_CHEST.get(), 4).key('#', useless_logs).patternLine("###").patternLine("# #").patternLine("###").setGroup("chest").addCriterion("has_useless_log", hasItem(useless_logs)).build(consumer, rl("useless_chest_logs"));
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_SIGN.get(), 3).key('#', BlockInit.USELESS_OAK_PLANKS.get()).key('X', Tags.Items.RODS_WOODEN).patternLine("###").patternLine("###").patternLine(" X ").setGroup("sign").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(BlockInit.USELESS_OAK_PRESSURE_PLATE.get()).key('#', BlockInit.USELESS_OAK_PLANKS.get()).patternLine("##").setGroup("wooden_pressure_plate").addCriterion("has_planks", hasItem(BlockInit.USELESS_OAK_PLANKS.get())).build(consumer);
