...
public class UselessBlockLootTables extends BlockLootTables {
    ...
    protected void addTables() {
        ...
        this.registerFlowerPot(BlockInit.POTTED_USELESS_OAK_SAPLING.get());
        this.registerDropSelfLootTable(BlockInit.RED_ROSE.get());
        this.registerDropSelfLootTable(BlockInit.STRIPPED_USELESS_OAK_LOG.get());
        this.registerDropSelfLootTable(BlockInit.STRIPPED_USELESS_OAK_WOOD.get());
        ...
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_BUTTON.get());
        this.registerDropSelfLootTable(BlockInit.USELESS_CARPET.get());
        this.registerLootTable(BlockInit.USELESS_OAK_CHEST.get(), BlockLootTables::droppingWithName);
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_FENCE.get());
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_FENCE_GATE.get());
        this.registerDropSelfLootTable(BlockInit.USELESS_GENERATOR.get());
        this.registerLootTable(BlockInit.USELESS_OAK_LEAVES.get(), leaves -> droppingWithChancesSticksAndApples(leaves, BlockInit.USELESS_OAK_SAPLING.get(), DEFAULT_SAPLING_DROP_RATES));
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_LOG.get());
        ...
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_PLANKS.get());
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_PRESSURE_PLATE.get());
        ...
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_SAPLING.get());
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_SIGN.get());
        this.registerLootTable(BlockInit.USELESS_OAK_SLAB.get(), BlockLootTables::droppingSlab);
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_STAIRS.get());
        ...
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_WOOD.get());
        this.registerLootTable(BlockInit.WALL_CLOSET.get(), UselessBlockLootTables::droppingWallCloset);
        this.registerLootTable(BlockInit.USELESS_OAK_DOOR.get(), BlockLootTables::registerDoor);
        this.registerDropSelfLootTable(BlockInit.USELESS_OAK_TRAPDOOR.get());
    }
