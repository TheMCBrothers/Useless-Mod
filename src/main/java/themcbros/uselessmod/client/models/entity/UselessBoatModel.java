package themcbros.uselessmod.client.models.entity;
...
public class UselessBoatModel extends SegmentedModel<UselessBoatEntity> {
     ...
     */
    public void setRotationAngles(UselessBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    protected void func_228244_a_(UselessBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
