...
import themcbros.uselessmod.client.models.entity.UselessBoatModel;
import themcbros.uselessmod.entity.UselessBoatEntity;

public class UselessBoatRenderer extends EntityRenderer<UselessBoatEntity> {
    private static final ResourceLocation[] BOAT_TEXTURES = new ResourceLocation[]{UselessMod.rl("textures/entity/boat/useless.png"), UselessMod.rl("textures/entity/boat/super_useless.png")};
    protected final UselessBoatModel modelBoat = new UselessBoatModel();

    public UselessBoatRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.8F;
    }

    public void render(UselessBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(UselessBoatEntity entity) {
