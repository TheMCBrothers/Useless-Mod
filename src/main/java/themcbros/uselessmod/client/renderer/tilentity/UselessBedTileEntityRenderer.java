...
public class UselessBedTileEntityRenderer extends TileEntityRenderer<UselessBedTileEntity> {
    ...
    public UselessBedTileEntityRenderer(TileEntityRendererDispatcher p_i226004_1_) {
        super(p_i226004_1_);
    ...
    public void render(UselessBedTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        RenderMaterial rendermaterial = new RenderMaterial(Atlases.BED_ATLAS, UselessMod.rl("entity/bed/useless"));
        World world = tileEntityIn.getWorld();
        if (world != null) {
            BlockState blockstate = tileEntityIn.getBlockState();
            TileEntityMerger.ICallbackWrapper<? extends BedTileEntity> iCallbackWrapper = TileEntityMerger.func_226924_a_(TileEntityType.BED, BedBlock::getMergeType, BedBlock::getFootDirection, ChestBlock.FACING, blockstate, world, tileEntityIn.getPos(), (p_228846_0_, p_228846_1_) -> false);
