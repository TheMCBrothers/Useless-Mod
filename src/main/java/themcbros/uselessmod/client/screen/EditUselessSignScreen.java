...
import themcbros.uselessmod.client.renderer.tilentity.UselessSignTileEntityRenderer;

import java.util.stream.IntStream;

public class EditUselessSignScreen extends Screen {
    ...
    public EditUselessSignScreen(SignTileEntity teSign) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderMaterial rendermaterial = UselessSignTileEntityRenderer.getMaterial();
        IVertexBuilder ivertexbuilder = rendermaterial.getBuffer(bufferSource, this.signModel::getRenderType);
        ...
        for(int i1 = 0; i1 < this.field_238846_r_.length; ++i1) {
            ...
            if (s != null) {
                ...
                this.minecraft.fontRenderer.func_238411_a_(s, f3, (float)(i1 * 10 - this.field_238846_r_.length * 5), i, false, matrix4f, bufferSource, false, 0, 15728880, false);
                if (i1 == this.editLine && j >= 0 && flag1) {
                    ...
                    if (j >= s.length()) {
                        this.minecraft.fontRenderer.func_238411_a_("_", (float)k1, (float)l, i, false, matrix4f, bufferSource, false, 0, 15728880, false);
                    }
                }
            }
        }
