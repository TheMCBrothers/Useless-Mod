...
public class ElectricCrusherBlock extends MachineBlock {

	public ElectricCrusherBlock(Properties builder) {
		super(builder);
	}
	...
	public void openContainer(World world, BlockPos pos, PlayerEntity player) {
		...
		if(tileEntity instanceof ElectricCrusherTileEntity && player instanceof ServerPlayerEntity) {
