...
public class ModItems {
	...
	@ObjectHolder("fload_bucket")
	public static final Item FLOAD_BUCKET = null;
...
//			registry.register(new BucketItem(ModFluids.FLOAD, (new Item.Properties()).containerItem(Items.BUCKET).maxStackSize(1).group(ModItemGroups.USELESS_ITEM_GROUP)));
